...
const LBRow: FC<LBRowProps> = ({ rank, name, logo, score }) => (
    <div className={`flex flex-row text-center items-center bg-black/90 w-full justify-between p-2 border-yellow-100 border-[1px]`}>
        <div className='w-16'>{toOrdinal(rank)}</div>
        <img src={logo} height={35} width={35} className='rounded-full ml-4' />
