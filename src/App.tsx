...
import Season3Leaderboard from "./pages/Season3";
...
function App() {
  return (
    <div className="flex justify-center max-w-[600px] w-screen h-screen p-4">
      <Router>
        <Routes>
          <Route path="/" element={<Season3Leaderboard />} />
          <Route path="/TONNation/Pool1" element={<TONNationP1 />} />
          <Route
            path="/TONNation/Pool1/Details"
            element={<TONNationP1Details />}
          />
          <Route path="/TONNation/Pool2" element={<TONNationP2 />} />
          <Route
            path="/TONNation/Pool2/Details"
            element={<TONNationP2Details />}
          />
          <Route path="/TONNation/Pool3" element={<TONNationP3 />} />
          <Route
            path="/TONNation/Pool3/Details"
            element={<TONNationP3Details />}
          />
          <Route path="/TONNation/Pool4" element={<TONNationP4 />} />
          <Route
            path="/TONNation/Pool4/Details"
            element={<TONNationP4Details />}
          />
